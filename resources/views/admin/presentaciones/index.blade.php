            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Listado de presentaciones</h4>
                    </div>
                    <div class="card-body">
                        <form method="GET" action="{{ route('admin.presentaciones.index') }}" class="mb-3">
                            <div class="row g-2 align-items-end">
                                <div class="col-12 col-md-8">
                                    <label for="search" class="form-label mb-1">Buscar presentación</label>
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="search" id="search" class="form-control"
                                            value="{{ $search ?? '' }}" placeholder="Escribe el nombre de la presentación">
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center text-muted py-4">No hay presentaciones registradas.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                        ...
                        @if ($presentaciones->count() > 0)
                            <div
                                ...
                                <small class="text-muted">
                                    ...
                                    {{ $presentaciones->total() }} registros
                                </small>
                                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nombre" id="nombre" class="form-control"
                                value="{{ old('nombre') }}" placeholder="Nombre de la presentación">
                        </div>
        ...
        <div class="modal fade" id="editPresentacionModal-{{ $presentacion->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <form class="modal-content" method="POST"
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="nombre-{{ $presentacion->id }}">Nombre (*)</label>
                            <div class="input-group">
                                <span class="input-group-text d-flex justify-content-center align-items-center"
                                    style="width: 46px;"><i class="bi bi-box-seam"></i></span>
                                <input type="text" name="nombre" id="nombre-{{ $presentacion->id }}"
                                    class="form-control"
        ...
        <div class="modal fade" id="deletePresentacionModal-{{ $presentacion->id }}" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <form class="modal-content" method="POST"
                    ...
                    <div class="modal-body">
                        <p class="mb-0">¿Estás seguro de eliminar la presentación
